...
| M5 | **Build & release v1.8.0** | ✅ | PR #14 mergée dans main (M1-M4). Bump 1.7.0 → 1.8.0 (orchestrator, generator, version_info, manifest build.bat), hidden-imports `diag_compare` + `report.exec_summary` ajoutés au build, CHANGELOG + RELEASE_NOTES_v1.8.0 + ROADMAP. Exe buildé (wrapper .bat, astuce cwd/stdin), SHA-256 dans les notes, release GitHub v1.8.0. |
